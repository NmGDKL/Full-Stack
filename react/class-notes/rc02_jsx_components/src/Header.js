...
function Header(){
    return(
    <div style={{backgroundColor: "purple", color: "white", textAlign: "center"}}>   //*inline stylink
       <h1>CLARUSWAY</h1>
        <p style={pStyle}>Reinveth Yourself</p> //*alternatif: yukarıda constla değişken yapıp içine style yazdırdık,içinde parantez olduğu için ikinici paranteze gerek kalmadı.
    </div>  
    );
